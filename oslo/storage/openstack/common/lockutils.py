...
from oslo.storage.openstack.common.gettextutils import _, _LE, _LI
...
util_opts = [
    ...
    cfg.StrOpt('lock_path',
               default=os.environ.get("OSLO.STORAGE_LOCK_PATH"),
...
def main(argv):
    ...
    os.environ["OSLO.STORAGE_LOCK_PATH"] = lock_dir
    try:
